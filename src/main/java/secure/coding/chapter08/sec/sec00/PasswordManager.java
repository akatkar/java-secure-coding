package secure.coding.chapter08.sec.sec00;
 ...
 *
 * @description In this noncompliant code example, the doPrivileged() method is
 *              called from the openPasswordFile() method. The
 *              openPasswordFile() method is privileged and returns a
 *              FileInputStream for the sensitive password file to its caller.
 *              Because the method is public, it could be invoked by an
 *              untrusted caller.
 */
